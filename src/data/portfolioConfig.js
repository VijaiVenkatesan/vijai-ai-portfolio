export const portfolioConfig = {
  ...
  // ==========================================
  hero: {
    title: "Building Production-Grade AI Systems That Scale Across Enterprises",
    subtitle: "7+ years of experience transforming complex business challenges into high-impact, scalable AI solutions specializing in Agentic AI, Large Language Models, and Intelligent Document Processing.",
    githubAvatarUrl: "https://github.com/VijaiVenkatesan.png",
  },
...
My core philosophy is built around "Agentic Engineering"—moving beyond simple prompt wrappers to construct robust, autonomous LLM orchestration frameworks (using LangGraph, CrewAI, AutoGen) that can dynamically search, reason, and act within highly constrained enterprise bounds.`,
  ...
  contact: {
    ...
    phone: "+918825947952",
    phoneDisplay: "+91 8825947952",
    githubUrl: "https://github.com/VijaiVenkatesan",
    linkedinUrl: "https://www.linkedin.com/in/vijai-v-2b89841a3/",
    footerMessage: "Interested in discussing highly scalable AI architectures, enterprise automation, or multi-agent LLM systems? I am always open to exploring cutting-edge opportunities."
  },
